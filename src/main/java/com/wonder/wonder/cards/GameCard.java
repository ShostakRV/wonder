...
// brown second age
    ...
    SAWMILL(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.DOUBLE_WOOD, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),

    QUARRY(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.DOUBLE_STONE, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),

    BRICKYARD(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.DOUBLE_CLAY, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),

    FOUNDRY(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.DOUBLE_IRON, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),


//brown half

    TREE_FARM(1, players(6), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.WOOD_OR_CLAY, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
    EXCAVATION(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.STONE_OR_CLAY, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
    CLAY_PIT(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.IRON_OR_CLAY, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
    TIMBER_YARD(1, players(3), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.STONE_OR_WOOD, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
    FOREST_CAVE(1, players(5), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.WOOD_OR_IRON,WarPoint.simple(0),ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
    MINE(1, players(6), GameCardColor.BROWN, CalcPointStrategy.none(), GameResource.STONE_OR_IRON, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 1, OnBuildEvent.none(), BaseResource.NONE),
...
// Yellow card first age
    ...
    // trade card
    EAST_TRADING_POST(1, players(3), GameCardColor.YELLOW, CalcPointStrategy.none(), GameResource.NO_RESOURCE, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 0, OnBuildEvent.none(), BaseResource.NONE), //ActionSide.RIGHT,
    WEST_TRADING_POST(1, players(3), GameCardColor.YELLOW, CalcPointStrategy.none(), GameResource.NO_RESOURCE, WarPoint.simple(0), ScientistGuild.NONE, new ArrayList<>(), 0, OnBuildEvent.none(), BaseResource.NONE), //  ActionSide.LEFT,
    MARKETPLACE(1, players(3), GameCardColor.YELLOW, CalcPointStrategy.none(), GameResource.NO_RESOURCE, WarPoint.simple(0),ScientistGuild.NONE, new ArrayList<>(), 0, OnBuildEvent.none(), BaseResource.NONE),//  ActionSide.RIGHT_AND_LEFT,
