 ...
 */
@Getter
public enum MainCard implements GameCard {
...
//card what give point for vonderLevel
    ...
    MainCard(int age, List<Integer> onPlayers, GameCardColor gameCardColor, CalcPointStrategy calcPointStrategy, GameResource giveResource,
