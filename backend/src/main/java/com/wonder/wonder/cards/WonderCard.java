...
public enum WonderCard {
    ...
    THE_STATUE_OF_ZEUS_IN_OLYMPIA_SIDE_A(WonderSide.A, GameCard.STATUE_ZEUS_MAIN, GameCard.STATUE_ZEUS_FIRST_A, GameCard.STATUE_ZEUS_SECOND_A, GameCard.STATUE_ZEUS_THIRD_A),
    ...
    THE_STATUE_OF_ZEUS_IN_OLYMPIA_SIDE_B(WonderSide.B, GameCard.STATUE_ZEUS_MAIN, GameCard.STATUE_ZEUS_FIRST_B, GameCard.STATUE_ZEUS_SECOND_B, GameCard.STATUE_ZEUS_THIRD_B),
